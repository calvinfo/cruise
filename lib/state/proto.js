...
exports.send = function(name, req){
  ...
  peers.forEach(function (peer) {
    node.debug('sending to %s:%s', peer.host, peer.port);
...
/**
 * Debug function which forwards to the node's debug
 * function
 */

exports.debug = function(){
  return this.node.debug.apply(this.node, arguments);
}